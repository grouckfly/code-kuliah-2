...
int main() {
    ...
    do {
        cout << "\nMenu:\n";
        cout << "1. Menambah Node Secara Dinamis\n";
        cout << "2. Menghitung Jumlah Node Dalam Linked List\n";
        cout << "0. Keluar\n";
        ...
        switch (choice) {
            case 1: {
                int numNodes, data, position, subChoice;
                ...
                for (int i = 1; i <= numNodes; i++) {
                    ...
                    cout << "Tambahkan di (1) Awal, (2) Tengah, (3) Akhir: ";
                    cin >> subChoice;
